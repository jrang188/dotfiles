...
- `tui.json` — **Generated by Nix** (`nix/home/ai/opencode.nix` via `programs.opencode.tui`, written at build time to `~/.config/opencode/tui.json`). Terminal UI theme: sets `tokyonight`.
